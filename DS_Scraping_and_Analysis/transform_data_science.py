...
def mult_requirements():
    dff = pd.read_pickle(r'data_science.pickle')
    print("*********************************************************************")
    print(len(dff))
    print("*********************************************************************")

    # 8860
    df = list(dff.values())[8001:]
    count = 0
    first_dict = {}
    second_dict = {}
    third_dict = {}
    ...
    with open("first_dict_ds9.pickle", "wb") as h1:
        pickle.dump(first_dict, h1)
    with open("second_dict_ds9.pickle", "wb") as h2:
        pickle.dump(second_dict, h2)
    with open("third_dict_ds9.pickle", "wb") as h3:
        pickle.dump(third_dict, h3)
    with open("fourth_dict_ds9.pickle", "wb") as h4:
        pickle.dump(fourth_dict, h4)
    with open("fifth_dict_ds9.pickle", "wb") as h5:
        pickle.dump(fifth_dict, h5)

    df1 = pd.read_pickle(r'first_dict_ds9.pickle')
    print(len(df1))
    df2 = pd.read_pickle(r'second_dict_ds9.pickle')
    print(len(df2))
    df3 = pd.read_pickle(r'third_dict_ds9.pickle')
    print(len(df3))
    df4 = pd.read_pickle(r'fourth_dict_ds9.pickle')
    print(len(df4))
    df5 = pd.read_pickle(r'fifth_dict_ds9.pickle')
    print(len(df5))
